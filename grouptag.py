...
class GroupTagMod(loader.Module):
    ...
    async def создатьгрcmd(self, message):
    ...
    async def удалитьгрcmd(self, message):
    ...
    async def группаcmd(self, message):
